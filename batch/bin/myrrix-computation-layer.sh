#!/bin/bash
# chkconfig: 2345 99 1
# description: Provides Myrrix Computation Layer
...
start() {
        echo -n "Starting Myrrix Computation Layer"
        ...
        COMMAND_LINE="/usr/lib/jvm/jre-1.7.0/bin/java -Xmx1g ${JVM_FLAGS} \
          -jar /usr/local/myrrix-computation-layer/myrrix-computation-aws-1.0.2.jar \
...
stop() {
        echo -n "Stopping Myrrix Computation Layer"
